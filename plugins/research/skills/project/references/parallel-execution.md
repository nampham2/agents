...
| C7 | `plugins/research/skills/project/SKILL.md` | 110-112 | `Delegate only when isolation outweighs` |
...
| C12 | `plugins/research/skills/project/scripts/workspace_lib.py` | 2911-2919 | `unsupported schema_version` |
| C13 | `plugins/research/skills/project/scripts/workspace_lib.py` | 462-479 | `def _validate_evidence_reference(` |
| C14 | `plugins/research/skills/project/scripts/workspace_lib.py` | 3260-3272 | `shell=False,` |
| C15 | `plugins/research/skills/project/scripts/workspace_lib.py` | 3267-3275 | `command timed out after` |
| C16 | `plugins/research/skills/project/scripts/workspace_lib.py` | 3312-3325 | `must not see a half-written one` |
...
| C21 | `plugins/research/skills/project/scripts/workspace_lib.py` | 3853-3861 | `IMMUTABLE_PROJECT_FIELDS = (` |
...
| C25 | `plugins/research/skills/project/scripts/workspace_lib.py` | 3945-3953 | `lock_timeout: float = 5.0,` |
...
| C29 | `plugins/research/skills/project/scripts/workspace_lib.py` | 3968-4012 | `with DirectoryLock(project_dir / ".project.lock", timeout=lock_timeout):` |
| C30 | `plugins/research/skills/project/scripts/workspace_lib.py` | 4003-4011 | `The commit already landed` |
