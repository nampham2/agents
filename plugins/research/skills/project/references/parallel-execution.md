...
| C2 | `plugins/research/skills/project/scripts/workspace_lib.py` | 3409-3429 | `def _dependency_levels(` |
| C3 | `plugins/research/skills/project/scripts/workspace_lib.py` | 3430-3458 | `def build_task_graph(` |
| C4 | `plugins/research/skills/project/scripts/workspace_lib.py` | 3328-3335 | `def levels(` |
...
| C12 | `plugins/research/skills/project/scripts/workspace_lib.py` | 2829-2837 | `unsupported schema_version` |
| C13 | `plugins/research/skills/project/scripts/workspace_lib.py` | 462-479 | `def _validate_evidence_reference(` |
| C14 | `plugins/research/skills/project/scripts/workspace_lib.py` | 3178-3190 | `shell=False,` |
| C15 | `plugins/research/skills/project/scripts/workspace_lib.py` | 3185-3193 | `command timed out after` |
| C16 | `plugins/research/skills/project/scripts/workspace_lib.py` | 3230-3243 | `must not see a half-written one` |
...
| C21 | `plugins/research/skills/project/scripts/workspace_lib.py` | 3771-3779 | `IMMUTABLE_PROJECT_FIELDS = (` |
...
| C25 | `plugins/research/skills/project/scripts/workspace_lib.py` | 3863-3871 | `lock_timeout: float = 5.0,` |
...
| C29 | `plugins/research/skills/project/scripts/workspace_lib.py` | 3886-3930 | `with DirectoryLock(project_dir / ".project.lock", timeout=lock_timeout):` |
| C30 | `plugins/research/skills/project/scripts/workspace_lib.py` | 3921-3929 | `The commit already landed` |
